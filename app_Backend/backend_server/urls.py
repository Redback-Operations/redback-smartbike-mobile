...
urlpatterns = [
    ...
    path('signup/', views.signup, name='signup'),
    path('home/', views.home, name='home'),
    path('api/create_schedule/', views.create_schedule, name='create_schedule'), #create schedule 
    path('api/get_schedules/<str:email>/', views.get_schedules, name='get_schedules'),
    #path('redirected_home.html/', views.login, name='home'),
