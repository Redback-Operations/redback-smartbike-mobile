...
class SetWorkout2 extends StatefulWidget {
  const SetWorkout2({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<SetWorkout2> createState() => _SetWorkoutState();
}

class _SetWorkoutState extends State<SetWorkout2> {
  int _currentIndex = 0;
  late String wrkName;
                      ...
                      onTap: () {
                        if (validateFields()) {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => Workout2(title: 'Workout'),
                            ),
                          );
                        }
                      },
