...
class SetWorkout3 extends StatefulWidget {
  const SetWorkout3({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<SetWorkout3> createState() => _SetWorkoutState();
}

class _SetWorkoutState extends State<SetWorkout3> {
  int _currentIndex = 0;
  late String wrkName;
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Image.asset(
                      'lib/assets/img/running.jpg', // Replace 'your_image_asset.png' with your actual asset path
                      ...
                      onTap: () {
                        if (validateFields()) {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => Workout3(title: 'Workout'),
                            ),
                          );
                        }
                      },
