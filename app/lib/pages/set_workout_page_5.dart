...
class SetWorkout5 extends StatefulWidget {
  const SetWorkout5({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<SetWorkout5> createState() => _SetWorkoutState();
}

class _SetWorkoutState extends State<SetWorkout5> {
  int _currentIndex = 0;
  late String wrkName;
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Image.asset(
                      'lib/assets/img/pilates.jpg', // Replace 'your_image_asset.png' with your actual asset path
