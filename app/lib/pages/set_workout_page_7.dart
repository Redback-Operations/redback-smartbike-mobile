...
class SetWorkout7 extends StatefulWidget {
  const SetWorkout7({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<SetWorkout7> createState() => _SetWorkoutState();
}

class _SetWorkoutState extends State<SetWorkout7> {
  int _currentIndex = 0;
  late String wrkName;
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Image.asset(
                      'lib/assets/img/highintensity.jpg', // Replace 'your_image_asset.png' with your actual asset path
