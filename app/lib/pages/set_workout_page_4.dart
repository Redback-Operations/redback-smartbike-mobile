...
class SetWorkout4 extends StatefulWidget {
  ...
  @override
  State<SetWorkout4> createState() => _SetWorkoutState();
}
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Image.asset(
                      'lib/assets/img/yoga.jpg', // Replace 'your_image_asset.png' with your actual asset path
                      ...
                      onTap: () {
                        if (validateFields()) {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => Workout4(title: 'Workout'),
                            ),
                          );
                        }
                      },
